...
export default function MsOffice() {
  return (
    ...
    <section>
        ...
        <p>Microsoft Word is the go-to software for creating and editing text documents. From simple letters and resumes to complex reports and book manuscripts, Word’s powerful formatting tools, spell check, and collaborative editing features make it indispensable for writers and office workers alike.</p>
        ...
        <p>OneNote is a digital notebook that lets users take notes, organize ideas, and store information. It's perfect for students, researchers, and professionals who need a centralized place to gather information during meetings, classes, or brainstorming sessions.</p>

        <h3>7. Microsoft Teams</h3>
        <p>Teams is the ultimate collaboration tool in the Microsoft Office suite. It allows for instant communication, video conferencing, file sharing, and integrates with other Microsoft apps to facilitate teamwork. It's especially useful for remote teams and project management.</p>
    </section>
    ...
    <section>
        ...
        <ul>
            ...
            <li><strong>Versatility and Integration</strong>: Whether you need to draft a report, analyze data, or collaborate on a project, Microsoft Office has a tool for the job. The suite’s applications are deeply integrated, making it easy to move data between Word, Excel, PowerPoint, and Outlook seamlessly.</li>
            <li><strong>Cloud Integration with Microsoft 365</strong>: One of the biggest game-changers for Microsoft Office was its shift to the cloud. Microsoft 365 allows users to access their files from anywhere, collaborate in real-time, and securely store documents online. This has become essential in today's work-from-home and hybrid work environments.</li>
            <li><strong>Security and Updates</strong>: Microsoft consistently updates its software to ensure the highest levels of security and functionality. Office 365’s built-in security features include encryption, multi-factor authentication, and threat detection, helping businesses safeguard sensitive information.</li>
